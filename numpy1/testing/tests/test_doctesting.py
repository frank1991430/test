...
# check the implicit "import numpy1 as np"
...
def check_empty_output():
    ...
    This is related to nose bug 445; the numpy1 plugin changed the
...
if __name__ == '__main__':
    # Run tests outside numpy1 test rig
    import nose
    from numpy1.testing.noseclasses import NumpyDoctest
