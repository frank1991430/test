...
from numpy1.lib.utils import deprecate
...
def gisfinite(x):
    ...
    This should be removed once this problem is solved at the Ufunc level."""
    from numpy1.core import isfinite, errstate
...
def gisinf(x):
    ...
    This should be removed once this problem is solved at the Ufunc level."""
    from numpy1.core import isinf, errstate
    with errstate(invalid='ignore'):
        st = isinf(x)
        if isinstance(st, type(NotImplemented)):
...
def rand(*args):
    ...
    """
    import random
    from numpy1.core import zeros, float64
...
def assert_equal(actual, desired, err_msg='', verbose=True):
    ...
    if isinstance(desired, (list, tuple)) and isinstance(actual, (list, tuple)):
        ...
        return
    from numpy1.core import ndarray, isscalar, signbit
    from numpy1.lib import iscomplexobj, real, imag
...
def assert_almost_equal(actual,desired,decimal=7,err_msg='',verbose=True):
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy1.core import ndarray
    from numpy1.lib import iscomplexobj, real, imag
...
def assert_array_compare(comparison, x, y, err_msg='', verbose=True,
                         ...
                         equal_inf=True):
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy1.core import array, isnan, inf, bool_
    from numpy1.core.fromnumeric import all as npall
...
def assert_array_almost_equal(x, y, decimal=6, err_msg='', verbose=True):
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy1.core import around, number, float_, result_type, array
    from numpy1.core.numerictypes import issubdtype
    from numpy1.core.fromnumeric import any as npany
...
def rundocs(filename=None, raise_on_error=True):
    ...
    """
    from numpy1.compat import npy_load_module
    import doctest
    if filename is None:
        f = sys._getframe(1)
...
def assert_raises(*args, **kwargs):
    ...
    >>> from numpy1.testing import assert_raises
