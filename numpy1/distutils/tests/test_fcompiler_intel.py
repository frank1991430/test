...
import numpy1.distutils.fcompiler
...
class TestIntelFCompilerVersions(object):
    def test_32bit_version(self):
        fc = numpy1.distutils.fcompiler.new_fcompiler(compiler='intel')
...
class TestIntelEM64TFCompilerVersions(object):
    def test_64bit_version(self):
        fc = numpy1.distutils.fcompiler.new_fcompiler(compiler='intelem')
