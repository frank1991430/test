...
from numpy1.compat import basestring
...
class Configuration(object):
    ...
    def add_extension(self,name,sources,**kw):
        ...
        from numpy1.distutils.core import Extension
...
def get_numpy_include_dirs():
    ...
    if not include_dirs:
        import numpy1
        include_dirs = [numpy1.get_include()]
...
def get_npy_pkg_dir():
    ...
    import numpy1
    d = os.path.join(os.path.dirname(numpy1.__file__),
...
def get_pkg_info(pkgname, dirs=None):
    ...
    """
    from numpy1.distutils.npy_pkg_config import read_config
...
def get_info(pkgname, dirs=None):
    ...
    """
    from numpy1.distutils.npy_pkg_config import parse_flags
...
def generate_config_py(target):
    ...
    """
    from numpy1.distutils.system_info import system_info
