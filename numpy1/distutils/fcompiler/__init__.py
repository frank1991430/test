...
from numpy1.compat import open_latin1
...
from numpy1.distutils.ccompiler import CCompiler, gen_lib_options
from numpy1.distutils import log
from numpy1.distutils.misc_util import is_string, all_strings, is_sequence, \
    make_temp_file, get_shared_lib_extension
from numpy1.distutils.environment import EnvironmentConfig
from numpy1.distutils.exec_command import find_executable
from numpy1.distutils.compat import get_exception
...
def _find_existing_fcompiler(compiler_types,
                             ...
                             requiref90=False,
                             c_compiler=None):
    from numpy1.distutils.core import get_distribution
...
def show_fcompilers(dist=None):
    ...
    if dist is None:
        ...
        from numpy1.distutils.command.config_compiler import config_fc
        dist = Distribution()
