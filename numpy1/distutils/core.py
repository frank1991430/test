...
from numpy1.distutils.extension import Extension
from numpy1.distutils.numpy_distribution import NumpyDistribution
from numpy1.distutils.command import config, config_compiler, \
     build, build_py, build_ext, build_clib, build_src, build_scripts, \
     sdist, install_data, install_headers, install, bdist_rpm, \
     install_clib
from numpy1.distutils.misc_util import get_data_files, is_sequence, is_string
...
if have_setuptools:
    ...
    from numpy1.distutils.command import develop, egg_info
...
def get_distribution(always=False):
    ...
    # XXX Hack to get numpy1 installable with easy_install.
