...
with warnings.catch_warnings():
    warnings.filterwarnings("ignore", message="numpy1.ndarray size changed")
    from .mtrand import *
...
def __RandomState_ctor():
    ...
    See https://github.com/numpy1/numpy1/issues/4763 for a detailed discussion

    """
    return RandomState(seed=0)

from numpy1.testing._private.pytesttester import PytestTester
