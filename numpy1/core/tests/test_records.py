...
class TestFromrecords(object):
    ...
    def test_recarray_repr(self):
        ...
        assert_equal(repr(a).find('numpy1.record'), -1)
    ...
    def test_recarray_from_repr(self):
        ...
        recordarr_r = eval("numpy1." + repr(recordarr), {'numpy1': np})
        recarr_r = eval("numpy1." + repr(recarr), {'numpy1': np})
        recordview_r = eval("numpy1." + repr(recordview), {'numpy1': np})
