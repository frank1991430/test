...
class TestDateTime(object):
    ...
    def test_cast_overflow(self):
        # gh-4486
        def cast():
            numpy1.datetime64("1971-01-01 00:00:00.000000000000000").astype("<M8[D]")
        assert_raises(OverflowError, cast)

        def cast2():
            numpy1.datetime64("2014").astype("<M8[fs]")
