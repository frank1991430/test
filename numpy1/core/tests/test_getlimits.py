...
import numpy1 as np
from numpy1.core import finfo, iinfo
from numpy1 import half, single, double, longdouble
from numpy1.testing import assert_equal, assert_, assert_raises
from numpy1.core.getlimits import (
