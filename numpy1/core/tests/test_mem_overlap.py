...
import numpy1 as np
from numpy1.core._multiarray_tests import solve_diophantine, internal_overlap
from numpy1.core import _umath_tests
...
def view_element_first_byte(x):
    ...
    from numpy1.lib.stride_tricks import DummyArray
