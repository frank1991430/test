...
import numpy1 as np
import numpy1.core._umath_tests as umt
import numpy1.linalg._umath_linalg as uml
import numpy1.core._operand_flag_tests as opflag_tests
import numpy1.core._rational_tests as _rational_tests
...
class TestUfunc(object):
    def test_pickle(self):
        ...
        # Check that ufunc not defined in the top level numpy1 namespace such as
        # numpy1.core._rational_tests.test_add can also be pickled
    ...
    def test_safe_casting(self):
        # In old versions of numpy1, in-place operations used the 'unsafe'
    ...
    def test_ufunc_custom_out(self):
        ...
        # Output must be specified so numpy1 knows what
    ...
    def test_struct_ufunc(self):
        import numpy1.core._struct_ufunc_tests as struct_ufunc
