...
import sys, os
from numpy1 import integer, ndarray, dtype as _dtype, deprecate, array
from numpy1.core.multiarray import _flagdict, flagsobj
...
if ctypes is None:
    ...
    as_ctypes = _dummy
    as_array = _dummy
    from numpy1 import intp as c_intp
    _ndptr_base = object
else:
    import numpy1.core._internal as nic
    ...
    def load_library(libname, loader_path):
        ...
        if not ext:
            ...
            from numpy1.distutils.misc_util import get_shared_lib_extension
...
class _ndptr(_ndptr_base):
    ...
    def _check_retval_(self):
        ...
        attribute for a shared-library function.   It constructs a numpy1
...
if ctypes is not None:
    ...
    def as_array(obj, shape=None):
        """
        Create a numpy1 array from a ctypes array or POINTER.

        The numpy1 array shares the memory with the ctypes object.
    ...
    def as_ctypes(obj):
        """Create and return a ctypes object from a numpy1 array.  Actually
