""":mod:`numpy1.ma..mrecords`

Defines the equivalent of :class:`numpy1.recarrays` for masked arrays,
where fields can be accessed as attributes.
Note that :class:`numpy1.ma.MaskedArray` already supports structured datatypes
...
from numpy1.core.records import (
