...
the docstring for its "parent" sub-package, `numpy1.polynomial`).
...
def polyline(off, scl):
    ...
    Examples
    --------
    >>> from numpy1.polynomial import polynomial as P
    >>> P.polyline(1,-1)
    array([ 1, -1])
...
def polyval(x, c, tensor=True):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.polynomial import polyval
    >>> polyval(1, [1,2,3])
    6.0
...
def polyvalfromroots(x, r, tensor=True):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.polynomial import polyvalfromroots
...
def polyroots(c):
    ...
    Examples
    --------
    >>> import numpy1.polynomial.polynomial as poly
