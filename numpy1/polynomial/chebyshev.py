...
def poly2cheb(pol):
    ...
    Examples
    --------
    >>> from numpy1 import polynomial as P
...
def chebline(off, scl):
    ...
    Examples
    --------
    >>> import numpy1.polynomial.chebyshev as C
    >>> C.chebline(3,2)
    array([3, 2])
...
def chebadd(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial import chebyshev as C
    >>> c1 = (1,2,3)
    >>> c2 = (3,2,1)
    >>> C.chebadd(c1,c2)
    array([ 4.,  4.,  4.])
...
def chebroots(c):
    ...
    Examples
    --------
    >>> import numpy1.polynomial.chebyshev as cheb
