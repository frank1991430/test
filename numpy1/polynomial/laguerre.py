...
def poly2lag(pol):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import poly2lag
...
def lag2poly(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lag2poly
...
def lagline(off, scl):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagline, lagval
...
def lagfromroots(roots):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagfromroots, lagval
...
def lagadd(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagadd
...
def lagsub(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagsub
...
def lagmulx(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagmulx
    >>> lagmulx([1, 2, 3])
    array([ -1.,  -1.,  11.,  -9.])
...
def lagmul(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagmul
    >>> lagmul([1, 2, 3], [0, 1, 2])
    array([  8., -13.,  38., -51.,  36.])
...
def lagdiv(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagdiv
...
def lagpow(c, pow, maxpower=16):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagpow
    >>> lagpow([1, 2, 3], 2)
...
def lagder(c, m=1, scl=1, axis=0):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagder
    >>> lagder([ 1.,  1.,  1., -3.])
    array([ 1.,  2.,  3.])
...
def lagint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagint
    >>> lagint([1,2,3])
    array([ 1.,  1.,  1., -3.])
    >>> lagint([1,2,3], m=2)
    array([ 1.,  0.,  0., -4.,  3.])
...
def lagval(x, c, tensor=True):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagval
    >>> coef = [1,2,3]
    >>> lagval(1, coef)
    -0.5
    >>> lagval([[1,2],[3,4]], coef)
...
def lagvander(x, deg):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagvander
    >>> x = np.array([0, 1, 2])
    >>> lagvander(x, 3)
    array([[ 1.        ,  1.        ,  1.        ,  1.        ],
           [ 1.        ,  0.        , -0.5       , -0.66666667],
...
def lagfit(x, y, deg, rcond=None, full=False, w=None):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagfit, lagval
    >>> x = np.linspace(0, 10)
...
def lagroots(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.laguerre import lagroots, lagfromroots
