...
def poly2herm(pol):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import poly2herm
...
def herm2poly(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import herm2poly
...
def hermline(off, scl):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermline, hermval
...
def hermfromroots(roots):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermfromroots, hermval
...
def hermadd(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermadd
...
def hermsub(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermsub
...
def hermmulx(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermmulx
    >>> hermmulx([1, 2, 3])
    array([ 2. ,  6.5,  1. ,  1.5])
...
def hermmul(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermmul
    >>> hermmul([1, 2, 3], [0, 1, 2])
    array([ 52.,  29.,  52.,   7.,   6.])
...
def hermdiv(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermdiv
...
def hermpow(c, pow, maxpower=16):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermpow
    >>> hermpow([1, 2, 3], 2)
    array([ 81.,  52.,  82.,  12.,   9.])
...
def hermder(c, m=1, scl=1, axis=0):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermder
...
def hermint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermint
...
def hermval(x, c, tensor=True):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermval
    >>> coef = [1,2,3]
    >>> hermval(1, coef)
    11.0
...
def hermvander(x, deg):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermvander
    >>> x = np.array([-1, 0, 1])
    >>> hermvander(x, 3)
    array([[ 1., -2.,  2.,  4.],
           [ 1.,  0., -2., -0.],
...
def hermfit(x, y, deg, rcond=None, full=False, w=None):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermfit, hermval
    >>> x = np.linspace(-10, 10)
...
def hermroots(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite import hermroots, hermfromroots
    >>> coef = hermfromroots([-1, 0, 1])
    >>> coef
