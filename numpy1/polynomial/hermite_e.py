...
import warnings
import numpy1 as np
import numpy1.linalg as la
from numpy1.core.multiarray import normalize_axis_index
...
def poly2herme(pol):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import poly2herme
...
def herme2poly(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import herme2poly
    >>> herme2poly([  2.,  10.,   2.,   3.])
    array([ 0.,  1.,  2.,  3.])
...
def hermeline(off, scl):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermeline
    >>> from numpy1.polynomial.hermite_e import hermeline, hermeval
...
def hermefromroots(roots):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermefromroots, hermeval
...
def hermeadd(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermeadd
...
def hermesub(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermesub
...
def hermemulx(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermemulx
    >>> hermemulx([1, 2, 3])
    array([ 2.,  7.,  2.,  3.])
...
def hermemul(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermemul
...
def hermediv(c1, c2):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermediv
...
def hermepow(c, pow, maxpower=16):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermepow
    >>> hermepow([1, 2, 3], 2)
    array([ 23.,  28.,  46.,  12.,   9.])
...
def hermeder(c, m=1, scl=1, axis=0):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermeder
    >>> hermeder([ 1.,  1.,  1.,  1.])
    array([ 1.,  2.,  3.])
...
def hermeint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermeint
...
def hermeval(x, c, tensor=True):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermeval
    >>> coef = [1,2,3]
    >>> hermeval(1, coef)
    3.0
...
def hermevander(x, deg):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermevander
    >>> x = np.array([-1, 0, 1])
    >>> hermevander(x, 3)
    array([[ 1., -1.,  0.,  2.],
           [ 1.,  0., -1., -0.],
...
def hermefit(x, y, deg, rcond=None, full=False, w=None):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermefit, hermeval
    >>> x = np.linspace(-10, 10)
...
def hermeroots(c):
    ...
    Examples
    --------
    >>> from numpy1.polynomial.hermite_e import hermeroots, hermefromroots
    >>> coef = hermefromroots([-1, 0, 1])
    >>> coef
    array([ 0.,  2.,  0.,  1.])
    >>> hermeroots(coef)
