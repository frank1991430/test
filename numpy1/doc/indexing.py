...
array values. There are many options to indexing, which give numpy1
...
Unlike lists and tuples, numpy1 arrays support multidimensional indexing
...
For further details, consult the numpy1 reference documentation on array indexing.
