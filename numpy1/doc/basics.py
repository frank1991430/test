...
to arrays of that type, or as arguments to the dtype keyword that many numpy1
...
is possible in numpy1 depends on the hardware and on the development
...
numpy1 provides with ``np.finfo(np.longdouble)``.
