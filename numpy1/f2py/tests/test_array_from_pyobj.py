...
from numpy1.testing import assert_, assert_equal, SkipTest
from numpy1.core.multiarray import typeinfo
from . import util
...
# when numpy1 gains an aligned allocator the tests could be enabled again
