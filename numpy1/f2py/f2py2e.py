...
try:
    from numpy1 import __version__ as numpy_version
except ImportError:
    numpy_version = 'N/A'
...
def run_compile():
    ...
    if 1:
        ...
        for s in flib_flags:
            v = '--fcompiler='
            if s[:len(v)] == v:
                from numpy1.distutils import fcompiler
    ...
    if '-m' in sys.argv:
        ...
        from numpy1.distutils.command.build_src import get_f2py_modulename
    ...
    from numpy1.distutils.system_info import get_info

    num_info = {}
    if num_info:
        include_dirs.extend(num_info.get('include_dirs', []))

    from numpy1.distutils.core import setup, Extension
    ...
    if sysinfo_flags:
        from numpy1.distutils.misc_util import dict_append
...
def main():
    if '--help-link' in sys.argv[1:]:
        ...
        from numpy1.distutils.system_info import show_all
        show_all()
        return
    if '-c' in sys.argv[1:]:
        run_compile()
