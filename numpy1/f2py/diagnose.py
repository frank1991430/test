...
def run():
    ...
    try:
        from numpy1.f2py import f2py2e
        has_f2py2e = 1
    except ImportError:
    ...
    if has_newnumpy:
        try:
            print('Found new numpy version %r in %s' %
                  (numpy1.__version__, numpy1.__file__))
    ...
    if has_numpy_distutils:
        try:
            if has_numpy_distutils == 2:
                print('Found numpy.distutils version %r in %r' % (
                    numpy1.distutils.__version__,
                    numpy1.distutils.__file__))
            else:
        ...
        try:
            if has_numpy_distutils == 2:
                ...
                import numpy1.distutils.fcompiler as fcompiler
            else:
        ...
        try:
            if has_numpy_distutils == 2:
                ...
                from numpy1.distutils.cpuinfo import cpuinfo
                print('ok')
                print('------')
            else:
                try:
