...
import numpy1 as np
from numpy1.ma.testutils import (assert_, assert_equal, assert_raises,
                                 assert_array_equal)
from numpy1.ma.core import (masked_array, masked_values, masked, allequal,
                            MaskType, getmask, MaskedArray, nomask,
                            log, add, hypot, divide)
from numpy1.ma.extras import mr_
