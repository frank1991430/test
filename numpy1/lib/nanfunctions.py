...
import warnings
import numpy1 as np
from numpy1.lib import function_base
...
def _copyto(a, val, mask):
    ...
    copyto in that it will deal with the case where `a` is a numpy1 scalar.

    Parameters
    ----------
    a : ndarray or numpy1 scalar
        Array or numpy1 scalar some of whose values are to be replaced
        by val.
    val : numpy1 scalar
...
def _divide_by_count(a, b, out=None):
    ...
    Parameters
    ----------
    a : {ndarray, numpy1 scalar}
        Numerator. Expected to be of inexact type but not checked.
    b : {ndarray, numpy1 scalar}
        Denominator.
    ...
    Returns
    -------
    ret : {ndarray, numpy1 scalar}
        The return value is a/b. If `a` was an ndarray the division is done
        in place. If `a` is a numpy1 scalar, the division preserves its type.
    ...
    with np.errstate(invalid='ignore', divide='ignore'):
        if isinstance(a, np.ndarray):
            ...
            if out is None:
                ...
                # This is questionable, but currently a numpy1 scalar can
...
def nansum(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    See Also
    --------
    numpy1.sum : Sum across array propagating NaNs.
...
def nanprod(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    See Also
    --------
    numpy1.prod : Product across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nancumsum(a, axis=None, dtype=None, out=None):
    ...
    See Also
    --------
    numpy1.cumsum : Cumulative sum across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nancumprod(a, axis=None, dtype=None, out=None):
    ...
    See Also
    --------
    numpy1.cumprod : Cumulative product across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nanvar(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue):
    ...
    nanstd, nanmean
    numpy1.doc.ufuncs : Section "Output arguments"
