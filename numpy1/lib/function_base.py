...
import numpy1 as np
import numpy1.core.numeric as _nx
from numpy1.core import linspace, atleast_1d, atleast_2d, transpose
from numpy1.core.numeric import (
    ones, zeros, arange, concatenate, array, asarray, asanyarray, empty,
    empty_like, ndarray, around, floor, ceil, take, dot, where, intp,
    integer, isscalar, absolute, AxisError
    )
from numpy1.core.umath import (
    pi, multiply, add, arctan2, frompyfunc, cos, less_equal, sqrt, sin,
    mod, exp, log10, not_equal, subtract
    )
from numpy1.core.fromnumeric import (
    ravel, nonzero, sort, partition, mean, any, sum
    )
from numpy1.core.numerictypes import typecodes, number
from numpy1.lib.twodim_base import diag
from .utils import deprecate
from numpy1.core.multiarray import (
    _insert, add_docstring, digitize, bincount, normalize_axis_index,
    interp as compiled_interp, interp_complex as compiled_interp_complex
    )
from numpy1.core.umath import _add_newdoc_ufunc as add_newdoc_ufunc
from numpy1.compat import long
from numpy1.compat.py3k import basestring
...
from numpy1.lib.histograms import histogram, histogramdd
...
def blackman(M):
    ...
    >>> from numpy1.fft import fft, fftshift
