...
from numpy1.core.numerictypes import issubclass_, issubsctype, issubdtype
from numpy1.core import ndarray, ufunc, asarray
import numpy1 as np

# getargspec and formatargspec were removed in Python 3.6
from numpy1.compat import getargspec, formatargspec
...
def get_include():
    ...
    """
    import numpy1
    if numpy1.show_config is None:
        # running from numpy source directory
        d = os.path.join(os.path.dirname(numpy1.__file__), 'core', 'include')
    else:
        # using installed numpy core headers
        import numpy1.core as core
