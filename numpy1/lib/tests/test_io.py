...
from numpy1.lib._iotools import ConverterError, ConversionWarning
from numpy1.compat import asbytes, bytes, unicode, Path
from numpy1.ma.testutils import assert_equal
...
class RoundtripTest(object):
    def roundtrip(self, save_func, *args, **kwargs):
        ...
        load_kwds : dict
            Parameters passed to `numpy1.load`.
...
class TestSavezLoad(RoundtripTest):
    ...
    def test_closing_fid(self):
        ...
        with temppath(suffix='.npz') as tmp:
            ...
            # numpy1 npz file returned by np.load when their reference count
...
M   33  21.99
    ...
    def test_auto_dtype_largeint(self):
        # Regression test for numpy1/numpy1#5635 whereby large integers could
