...
from numpy1.core import arange
from numpy1.testing import assert_, assert_equal, assert_raises_regex
from numpy1.lib import deprecate
import numpy1.lib.utils as utils
